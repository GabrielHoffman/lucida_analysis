...
plot_grid(fig1, fig2, fig3, fig4, fig5, ncol=3)
# ggsave(fig, file="~/www/test.pdf", height=7, width=12)

fig5 = plotForest(fit, coef="age", gene = "ENSG00000197747" ) +theme(aspect.ratio=1)

# pdf("~/www/test.pdf", height=7, width=12)
