...
rsync -avPz minerva:/sc/arion/work/hoffmg01/lucida_analysis/simulations/df.RDS ~/workspace/repos/lucida_analysis/simulations/1k1k_v1/
...
file = "/sc/arion/work/hoffmg01/lucida_analysis/simulations/df.RDS"
df = readRDS(file) %>%
  mutate(cluster_id = factor(cluster_id, CTs))
```
